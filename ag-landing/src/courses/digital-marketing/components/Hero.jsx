    ...
    <section className="w-full bg-gradient-to-br from-blue-50 via-white to-blue-50 text-gray-900 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          ...
          {/* Headline with SEO-optimized structure */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Become a{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-800">
              Job-Ready Digital Marketing Expert
            </span>{" "}
            in 90 Days
          </h1>

          {/* Subheadline - SEO rich description */}
          <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed max-w-xl mx-auto md:mx-0">
            Master <strong>SEO</strong>, <strong>Social Media Marketing</strong>, <strong>Google Ads</strong>, <strong>Meta Ads</strong>, <strong>Content Marketing</strong>, <strong>Email Marketing</strong>, and <strong>Analytics</strong> with hands-on projects and live campaigns. No experience needed.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center md:items-start gap-4 mb-8">
            <button 
              ...
              aria-label="Enroll in Digital Marketing Course"
            >
              🚀 Reserve My Seat Now
            </button>
            ...
            <button 
              ...
              aria-label="Download course curriculum"
            >
              📥 Download Curriculum
            </button>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 text-sm text-gray-600 mb-8">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">100% Practical Training</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <span className="font-semibold">Industry Certification</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z" />
              </svg>
              <span className="font-semibold">Live Campaign Training</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center md:justify-start gap-4 p-4 bg-white rounded-xl border border-blue-100 shadow-sm">
            ...
            <div className="text-left">
              <p className="font-bold text-blue-700 text-lg">2,000+ Students</p>
              <p className="text-sm text-gray-600">Enrolled in Last 6 Months</p>
            </div>
          </div>
        </div>
        ...
        <div className="md:w-1/2 flex justify-center md:justify-end relative">
          ...
          <div className="absolute -top-10 -right-10 w-72 h-72 bg-blue-200 rounded-full filter blur-3xl opacity-40 animate-pulse"></div>
          <div className="absolute -bottom-10 -left-10 w-60 h-60 bg-blue-300 rounded-full filter blur-3xl opacity-30"></div>

          {/* Floating badge elements */}
          <div className="absolute top-10 left-0 bg-white p-3 rounded-lg shadow-lg border border-blue-100 z-20 animate-bounce">
            <p className="text-xs font-semibold text-gray-600">SEO Certified</p>
            <p className="text-2xl font-bold text-blue-600">✓</p>
          </div>

          <div className="absolute bottom-20 left-5 bg-white p-3 rounded-lg shadow-lg border border-blue-100 z-20">
            <p className="text-xs font-semibold text-gray-600">Google Ads Expert</p>
          ...
          <img 
            ...
            alt="Digital Marketing Course - Learn SEO, Google Ads, Social Media Marketing" 
          ...
          <div className="absolute -bottom-5 right-5 bg-gradient-to-r from-blue-600 to-blue-700 text-white p-4 rounded-xl shadow-xl z-20">
            <p className="text-xs font-semibold opacity-90">Average Salary Increase</p>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-12">
        <div className="bg-white rounded-xl shadow-sm border border-blue-100 p-6">
          <p className="text-center text-sm text-gray-600 mb-4 font-semibold">Trusted by Students from</p>
