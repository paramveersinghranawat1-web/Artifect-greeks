      ...
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <div className="inline-flex items-center gap-2 px-5 py-2 mb-6 text-sm font-semibold text-blue-700 bg-blue-100 rounded-full border border-blue-200 shadow-sm animate-pulse">
            ...
            Limited Seats • QA Batch Closing Soon
          </div>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-800">
              Job-Ready Full Stack QA Engineer
            </span>{" "}
            in 90 Days
          </h1>
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed max-w-xl mx-auto md:mx-0">
            Master <strong>Manual Testing</strong>, <strong>Selenium</strong>, <strong>Java</strong>, <strong>API Testing</strong>, <strong>Postman</strong>, <strong>TestNG</strong>, <strong>Automation Frameworks</strong>, <strong>CI/CD Integration</strong>, and <strong>Agile Methodologies</strong> with real-time projects and hands-on practice. No prior experience required.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center md:items-start gap-4 mb-8">
            <button 
              ...
              aria-label="Enroll in Full Stack QA Course"
            >
              🚀 Reserve My QA Seat
            </button>
            ...
            <button 
              ...
              aria-label="Download QA course curriculum"
            >
              📥 Download QA Curriculum
            </button>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 text-sm text-gray-600 mb-8">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">100% Practical Testing Training</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">Live Projects & Automation Framework Building</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center md:justify-start gap-4 p-4 bg-white rounded-xl border border-blue-100 shadow-sm">
            ...
            <div className="text-left">
              <p className="font-bold text-blue-700 text-lg">1,800+ QA Students</p>
        ...
        <div className="md:w-1/2 flex justify-center md:justify-end relative">
          ...
          <div className="absolute top-10 left-0 bg-white p-3 rounded-lg shadow-lg border border-blue-100 z-20 animate-bounce">
            <p className="text-xs font-semibold text-gray-600">Selenium Certified</p>
            <p className="text-2xl font-bold text-blue-600">✓</p>
          </div>

          <div className="absolute bottom-20 left-5 bg-white p-3 rounded-lg shadow-lg border border-blue-100 z-20">
            <p className="text-xs font-semibold text-gray-600">API Testing Expert</p>
            <p className="text-xl">🧪</p>
          </div>

          <img 
            src="/images/full-stack-qa.png" 
            alt="Full Stack QA Course - Learn Selenium, Java, API Testing, Automation"
      ...
      <div className="max-w-7xl mx-auto px-6 pb-12">
        <div className="bg-white rounded-xl shadow-sm border border-blue-100 p-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 opacity-60">
            <span className="text-xl font-bold text-gray-400">Selenium</span>
            <span className="text-xl font-bold text-gray-400">Java</span>
            <span className="text-xl font-bold text-gray-400">Postman</span>
            <span className="text-xl font-bold text-gray-400">TestNG</span>
            <span className="text-xl font-bold text-gray-400">Jenkins</span>
          </div>
        </div>
      </div>
    </section>
