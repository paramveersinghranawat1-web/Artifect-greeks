...
const modules = [
  {
    ...
    skills: ["Linux", "Shell Scripting", "Networking Basics"],
  },
  {
    icon: "🔧",
    ...
    topics: [
      ...
      "Git Workflows (Feature Branching)"
    ],
  ...
  },
  {
    ...
    skills: ["AWS", "Cloud Deployment", "Infrastructure Management"],
  },
  {
    icon: "🚀",
    title: "Kubernetes & Live DevOps Projects",
    duration: "2 Weeks",
    level: "Advanced",
    topics: [
      ...
      "Real-Time DevOps Project Deployment"
    ],
    skills: ["Kubernetes", "Helm", "Production Deployment"],
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            Our comprehensive <strong>DevOps Training Program</strong> covers{" "}
            <strong>Linux</strong>, <strong>Git</strong>, <strong>CI/CD</strong>,{" "}
            <strong>Docker</strong>, <strong>Kubernetes</strong>, and <strong>AWS Cloud</strong>.
            This industry-focused curriculum is designed to make you{" "}
            <strong>job-ready DevOps Engineer within 90 days</strong>.
          </p>
                ...
                {activeModule === index && (
                  <div className="mt-4 p-4 bg-blue-50 rounded-xl border border-blue-100 animate-fadeIn">
                    <p className="text-sm text-gray-700 leading-relaxed">
                      ...
                      real-time infrastructure setup, and production-level deployment experience.
                      You'll receive personalized guidance and recorded sessions access.
                    </p>
                  </div>
                )}
              </div>
